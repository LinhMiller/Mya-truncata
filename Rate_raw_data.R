...
### at target temperature measurement
...
library(respfun)
#eff_vol(resp_vol = 387/1000, spec_mass = 46.6/1000, spec_density = 1026)

###convert rate to mass specific at INT
DT_VOL <- read_excel("./output/Iqaluit_sum_results_raw.xlsx")

EFF_VOL<- eff_vol(resp_vol = DT_VOL$tt_volume_L, # total respirometer vol in L
        spec_vol = NULL, 
        spec_mass = DT_VOL$mass_whole_kg, # specimen mass in kg
        spec_density = NULL,
        t = DT_VOL$temp_c_int, # C
        S = DT_VOL$salinity_ppt, # ppt
        P = 1.013253) # default
EFF_VOL


###test if the vector works, whcih it did
#EFF_VOL<- eff_vol(resp_vol = 0.407, # total respirometer vol in L
                #spec_vol = NULL, 
#spec_mass = 0.0423, # specimen mass in kg
#spec_density = NULL,
#t = 7.12, # C
#S = 32, # ppt
#P = 1.013253) # default
...
Trt7INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt7_INT$eff_volume_L,
  mass = Trt7_INT$mass_whole_kg,
...
Trt10INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt10_INT$eff_volume_L,
  mass = Trt10_INT$mass_whole_kg,
...
Trt13INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt13_INT$eff_volume_L,
  mass = Trt13_INT$mass_whole_kg,
...
Trt16INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt16_INT$eff_volume_L,
  mass = Trt16_INT$mass_whole_kg,
...
Trt19INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt19_INT$eff_volume_L,
  mass = Trt19_INT$mass_whole_kg,
...
Trt22INT<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt22_INT$eff_volume_L,
  mass = Trt22_INT$mass_whole_kg,
  S= 31.5,
...
Trt7MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt7_MD$eff_volume_L,
  mass = Trt7_MD$mass_whole_kg,
...
Trt10MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt10_MD$eff_volume_L,
  mass = Trt10_MD$mass_whole_kg,
...
Trt13MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt13_MD$eff_volume_L,
  mass = Trt13_MD$mass_whole_kg,
...
Trt16MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt16_MD$eff_volume_L,
  mass = Trt16_MD$mass_whole_kg,
...
Trt19MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt19_MD$eff_volume_L,
  mass = Trt19_MD$mass_whole_kg,
...
Trt22MD<-convert_rate(
  ...
  time.unit = 's',
  output.unit = 'mg/h/kg',
  volume = Trt22_MD$eff_volume_L,
  mass = Trt22_MD$mass_whole_kg,
...
dt <-read_excel("./output/Iqaluit_convertedrate_raw_eff_vol.xlsx")
